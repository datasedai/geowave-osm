...
import mil.nga.giat.osm.parser.OsmPbfParserOptions;
...
public class StageOSMToHDFSCommand extends DefaultOperation implements Command {
	...
	public void execute(OperationParams params) throws Exception {
		...
		// These are set as main parameter arguments, to keep consistency with GeoWave.
	...
	public void setParserOptions(OsmPbfParserOptions parserOptions) {
