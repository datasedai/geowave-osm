...
import mil.nga.giat.osm.operations.IngestOSMToGeoWaveCommand;
import mil.nga.giat.osm.operations.StageOSMToHDFSCommand;
		...
		extends GeoWaveDFSTestEnvironment
{
	...
	public void testIngestOSMPBF()
		...
		stage.setParameters(TEST_DATA_BASE_DIR, NAME_NODE, hdfsPath);
		...
		ingest.setParameters(NAME_NODE, hdfsPath, null);
